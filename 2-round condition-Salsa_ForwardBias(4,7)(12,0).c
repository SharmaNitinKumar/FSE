...
int main()
{
	...
	int a, b, a1, b1, MISS_MATCH_1, MISS_MATCH_2;
	...
	while (loop < LOOP)
	{
		...
		/****** Second Condition Ends************/
			...
			if (MISS_MATCH_1 == 4 && MISS_MATCH_2 == 2) // Use this to check both conditions
				break;
		}
